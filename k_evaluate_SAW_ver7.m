...
%ver7更新内容(2024/11/08)
% 共振波形の中に共振波形が含まれる場合、Yangleが0になる位置がずれてしまうことを修正できるようにしました
...
left=1; %共振の中に共振が含まれる場合
right=1;
loadS=read_s1p(file); %s1pファイルからデータを取り出す
[k2(1),fr(1),fa(1)]=k(loadS,a,b,x(1),left,right); %k値と共振反共振周波数の算出
...
right=1;
loadS=read_s1p(file);
[k2(2),fr(2),fa(2)]=k(loadS,a,b,x(2),left,right);
...
right=1;
loadS=read_s1p(file);
[k2(3),fr(3),fa(3)]=k(loadS,a,b,x(3),left,right);
...
right=1;
loadS=read_s1p(file);
[k2(4),fr(4),fa(4)]=k(loadS,a,b,x(4),left,right);
...
right=1;
loadS=read_s1p(file);
[k2(5),fr(5),fa(5)]=k(loadS,a,b,x(5),left,right);
...
right=1;
loadS=read_s1p(file);
[k2(6),fr(6),fa(6)]=k(loadS,a,b,x(6),left,right);
...
right=1;
loadS=read_s1p(file);
[k2(7),fr(7),fa(7)]=k(loadS,a,b,x(7),left,right);
...
right=1;
loadS=read_s1p(file);
[k2(8),fr(8),fa(8)]=k(loadS,a,b,x(8),left,right);
...
right=1;
loadS=read_s1p(file);
[k2(9),fr(9),fa(9)]=k(loadS,a,b,x(9),left,right);
...
right=1;
loadS=read_s1p(file);
[k2(10),fr(10),fa(10)]=k(loadS,a,b,x(10),left,right);
...
% right=1;
% loadS=read_s1p(file);
% [k2(11),fr(11),fa(11)]=k(loadS,a,b,x(11),left,right);
% 
% file=('2.5.s1p');
% x(12)=2.5;
% a=1;
...
% right=1;
% loadS=read_s1p(file);
% [k2(12),fr(12),fa(12)]=k(loadS,a,b,x(12),left,right);
% 
% file=('10.s1p');
% x(13)=10;
% a=1;
...
% right=1;
% loadS=read_s1p(file);
% [k2(13),fr(13),fa(13)]=k(loadS,a,b,x(13),left,right);
% 
% file=('7.5.s1p');
% x(14)=7.5;
% a=1;
...
% right=1;
% loadS=read_s1p(file);
% [k2(14),fr(14),fa(14)]=k(loadS,a,b,x(14),left,right);
...
% right=1;
% loadS=read_s1p(file);
% [k2(15),fr(15),fa(15)]=k(loadS,a,b,x(15),left,right);
% 
% file=('.s1p');
% x(16)=10;
% a=1;
...
% right=1;
% loadS=read_s1p(file);
% [k2(16),fr(16),fa(16)]=k(loadS,a,b,x(16),left,right);
% 
% file=('.s1p');
% x(17)=10;
% a=1;
...
% right=1;
% loadS=read_s1p(file);
% [k2(17),fr(17),fa(17)]=k(loadS,a,b,x(17),left,right);
% 
% file=('.s1p');
% x(18)=10;
% a=1;
...
% right=1;
% loadS=read_s1p(file);
% [k2(18),fr(18),fa(18)]=k(loadS,a,b,x(18),left,right);
% 
% file=('.s1p');
% x(19)=10;
% a=1;
...
% right=1;
% loadS=read_s1p(file);
% [k2(19),fr(19),fa(19)]=k(loadS,a,b,x(19),left,right);
% 
% file=('.s1p');
% x(20)=10;
% a=1;
...
% right=1;
% loadS=read_s1p(file);
% [k2(20),fr(20),fa(20)]=k(loadS,a,b,x(20),left,right);
...
%%以降、関数の定義
%k値の算出
function [k2_fsfp,fr,fa]=k(loadS,a,b,xaxis,left,right)
F_exp = loadS(:,1);
s11_abs_exp = (loadS(:,2));
